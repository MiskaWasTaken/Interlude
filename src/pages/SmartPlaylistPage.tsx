      ...
      try {
        ...
        switch (playlistId) {
          ...
          case "hires":
            ...
            playlistTracks = allTracksHires.filter(
              (t) => t.bit_depth >= 24 || t.sample_rate > 48000,
            );
            break;
        }
    ...
    <div className="p-6 pb-28">
        ...
        <div
          className={clsx(
            ...
            playlistId === "favorites" &&
              "bg-linear-to-br from-red-900/30 to-pink-900/30",
            playlistId === "recently-added" &&
              "bg-linear-to-br from-yellow-900/30 to-orange-900/30",
            playlistId === "hires" &&
              "bg-linear-to-br from-green-900/30 to-emerald-900/30",
          )}
        >
      ...
      {tracks.length > 0 ? (
        ...
        <div className="text-center py-16">
          <Icon
            className={clsx("w-16 h-16 mx-auto mb-4", playlistInfo.color)}
          />
