...
export function AudioWaveIcon({ className }: IconProps) {
  return (
    <svg
      ...
      strokeLinejoin="round"
    >
      <path d="M2 12h2l2-6 2 12 2-9 2 15 2-6 2 3 2-9 2 6h2" />
    </svg>
  );
}
...
export function RepeatOneIcon({ className }: IconProps) {
  return (
    ...
    >
      ...
      <polyline points="7 23 3 19 7 15" />
      <path d="M21 13v2a4 4 0 0 1-4 4H3" />
      <text x="12" y="15" fontSize="8" fill="currentColor" textAnchor="middle">
        1
      </text>
    </svg>
  );
...
export function ABLoopIcon({ className }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
    ...
    >
      ...
      <text x="15" y="16" fontSize="10" fill="currentColor">
        B
      </text>
    </svg>
  );
...
export function PinIcon({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
      <path d="M19.5 9.5L14.5 4.5L16 3L21 8L19.5 9.5ZM5 21L9.5 16.5L7.5 14.5L3 19V21H5ZM14 10L9.5 5.5L11 4L16 9L14 10ZM12 12L9 15L14.5 20.5L15.5 19.5L12 12Z" />
    </svg>
  );
}
